"""
Pure quantitative risk models, lot sizing formulas, and statistical profiling.
...
from domain.models.calculation import LotCalculationResult
from domain.math.margin_engine import calculate_required_margin
